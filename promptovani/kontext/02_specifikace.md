...
> „Prosím, navrhni, jak bys postupoval při řešení problému, který se probíral na této schůzce.“

Model pak nenavrhuje hned konkrétní řešení, ale nejdříve **rozepíše logiku uvažování a jednotlivé kroky**. Díky tomu získáte materiál, který můžete:
- **dále upravovat a rozšiřovat**,
- **použít jako vlastní pracovní postup při analýze**,
- nebo jej **znovu využít v dalších promtech** pro řešení jednotlivých dílčích částí problému.